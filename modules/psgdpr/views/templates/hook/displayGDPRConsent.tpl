...
{block name='gdpr_checkbox'}
    <div class="gdpr_module_{$psgdpr_id_module|escape:'htmlall':'UTF-8'} rodo-module">
        <label class="mxb-checkbox rodo-module-checkbox" for="psgdpr_consent_checkbox_{$psgdpr_id_module|escape:'htmlall':'UTF-8'}">
        ...
        <label class="rodo-module-label" for="psgdpr_consent_checkbox_{$psgdpr_id_module|escape:'htmlall':'UTF-8'}">
            {$psgdpr_consent_message nofilter}
        </label>
    </div>
{/block}
{literal}
